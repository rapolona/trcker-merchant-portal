...
return [
    ...
    */
    ...
    'logo' => '<b>Trackr</b>',
    'logo_img' => 'vendor/adminlte/dist/img/trckr.png',
    ...
    */
    ...
    'menu' => [
        ...
        */
        ...
        [
            'icon_color' => 'red',
            'text' => 'Finished Task Ticket Rejection',
            'url'  => 'ticket/reject',
            'icon' => 'fas fa-fw fa-sticky-note',
        ],
        */
        ...
        'DateRangePicker' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'css',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/bootstrap-daterangepicker/3.0.5/daterangepicker.css',
                ],
            ],
        ],
        'Chartjs' => [
        ...
        'JqueryUI' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//code.jquery.com/ui/1.12.0/jquery-ui.js',
                ],
            ]
        ]
    ],
