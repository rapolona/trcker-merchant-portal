...
@section('content')
    <form method="post" action="{{ url('campaign/create') }}">
                        ...
                        <div class="row row-30">
                            <div class="col-md-6">
                                <div class="input-group form-group">
                                    ...
                                    <input class="form-control" type="text" required name="campaign_name" placeholder="Campaign Name">
                                </div>
                                <div class="input-group form-group">
                                    <div class="input-group-prepend"><span class="input-group-text"><span class="fa-black-tie"></span></span></div>
                                    <input class="form-control" type="number" required name="budget" placeholder="Budget">
                                </div>
                ...
                <div class="panel">
                    ...
                    <div class="panel-body p-0">
                        <div class="table-responsive scroller scroller-horizontal py-3">
                            <table class="table table-striped table-hover data-table" data-table-searching="true" data-table-lengthChange="true" data-page-length="10">
                                <thead>
                                <tr>
                                    <td style="width: 40px">
                                    ...
                                    <th>City</th>
                                    <th>Region</th>
                                    <th style="width: 130px"><input class="form-control" type="number" id="defaultMax" placeholder="Default Max Submission"></th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach ($branches as $branch)
                                    <tr>
                                        <td style="width: 40px">
                                            <div class="custom-control custom-checkbox custom-checkbox-success">
                                                <input class="custom-control-input" type="checkbox" name="branch_id[]" id="{{ $branch->branch_id }}" value="{{ $branch->branch_id }}" />
                                        ...
                                        <td>{{ $branch->city }}</td>
                                        <td>{{ $branch->region }}</td>
                                        <td><input class="form-control" type="number" name="respondent_count[]" placeholder="Max Submission"></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                            ...
                            <div class="row row-30 task-container">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group task-action-container">
                                        <select class="form-control select2 task_actions" required multiple="multiple" name="task_id[]" style="width: 100%;">
                                            <option value="">Select One</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="input-group">
                                        ...
                                        <input class="form-control" type="number" name="reward_amount[]" placeholder="Reward">
                                    </div>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function (e) {
            ...
            $(document).on('click', '#add_task', function(){
                ...
                $('.task-action-container',clonedTask).html('<select required class="form-control select2 task_actions" multiple="multiple" name="task_actions[]" style="width: 100%;">' +
                    '<option value="">Select One</option>' +
                    '</select>');
