        ...
        <div class="panel-body">
            <form class="form-vertical" method="post">
                ...
                <div class="row form-group {{ $errors->first('name')? 'text-danger' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input required type="text" class="form-control {{ $errors->first('name')? 'form-control-danger' : '' }}" id="input_name" name="name" value="{{ old('name', $branch->name ) }}" placeholder="Enter Branch Name">
                ...
                <div class="row form-group {{ $errors->first('address')? 'text-danger' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input required type="text" class="form-control {{ $errors->first('address')? 'form-control-danger' : '' }}" id="input_address" name="address" value="{{ old('address', $branch->address ) }}" placeholder="Enter Address">
                ...
                <div class="row form-group {{ $errors->first('city')? 'text-danger' : '' }}">
                    ...
                    <div class="col-sm-10">
                        <input required type="text" class="form-control {{ $errors->first('city')? 'form-control-danger' : '' }}" id="input_city" name="city" value="{{ old('city', $branch->city ) }}" placeholder="Enter City">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" required class="form-control {{ $errors->first('longitude')? 'form-control-danger' : '' }}" id="input_longitude" name="longitude" value="{{ old('longitude', $branch->longitude ) }}" placeholder="Enter Longitude">
                    ...
                    <div class="col-sm-5">
                        <input type="text" required class="form-control {{ $errors->first('latitude')? 'form-control-danger' : '' }}" id="input_latitude" name="latitude" value="{{ old('latitude', $branch->latitude ) }}" placeholder="Enter Latitude">
